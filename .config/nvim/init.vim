...
function! s:custom_jarvis_colors()
  ...
  hi Search guibg=#476088 guifg=#4FDDC3
  "hi Search guifg=#ff00ff guibg=#19242C ctermfg=grey ctermbg=blue
endfunction
...
vnoremap <leader><cr> :TREPLSendFile<cr> " send current selection
